...
const selectedModelRequest = computed(() =>
...
function getSelectedModelRequestBody() {
    ...
    ElMessage.warning(
        "请先在设置中添加并验证至少一个 AI 服务商模型后再开始会话。",
    );
    return null;
}
...
filePart, fileIndex
            ...
            <div v-if="!selectedModelRequest"
                ...
                <Button size="sm" @click="uiStore.openSettings()">
                    去配置
                </Button>
            </div>
