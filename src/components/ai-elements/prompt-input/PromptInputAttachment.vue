...
const promptInput = inject<PromptInputContext | null>(PROMPT_INPUT_KEY, null);
const canRemove = computed(() => !props.readonly && Boolean(promptInput));
...
function handleRemove(e: Event) {
    ...
    promptInput?.removeFile(props.file.id);
}
</script>
