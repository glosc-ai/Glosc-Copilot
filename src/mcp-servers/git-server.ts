...
class GitServer {
                ...
                inputSchema: {
                    ...
                    properties: {
                        ...
                        name: {
                            type: "string",
                            description:
                                "分支名称（用于 create、checkout、delete 操作）",
                        },
                    },
                },
            },
    ...
    private async gitLog(count: number, oneline: boolean): Promise<any> {
        ...
        if (oneline) {
            ...
            command +=
                ' --pretty=format:"%H%n作者: %an <%ae>%n日期: %ad%n%n%s%n%b%n"';
        }
